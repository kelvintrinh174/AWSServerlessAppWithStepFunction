...
Execute unit tests
```
    cd "MyServerlessApplicationWithStepFunctions/test/MyServerlessApplicationWithStepFunctions.Tests"
    dotnet test
```

Deploy application
```
    cd "MyServerlessApplicationWithStepFunctions/src/MyServerlessApplicationWithStepFunctions"
